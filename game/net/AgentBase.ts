...
export default class AgentBase {
    ...
    init() {
        ...
        this.socket.onmessage = (event:any) => {
            ...
            try {
                ...
                let msgtype:string = buffer.readString(headlen);
                ...
                if (func) {
                    ...
                    console.log(`客户端数据解析错误:[headlen:${headlen} type:${msgtype}]!`);
                }
                enbuffer = null;
                buffer = null;
            } catch (error:any) {
    ...
    update(dt: number) {
        ...
        if(!this.starttime){
            ...
            console.log(`${this.id}心跳超过1分钟断开连接!`);
            this.close();
        }
        /*
